...
/// \brief Calls \ref KinBody::CalculateAngularJacobian
///
/// \param[in] values uses this array to set the DOF values.
/// \param[out] jacobian row-major
OPENRAVE_C_API void ORCBodyGetAngularJacobianAtDOFValues(void* body, const dReal* values, dReal* jacobian);
